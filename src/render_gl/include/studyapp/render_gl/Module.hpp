...
/// Module anchor.
///
/// This module will contain the OpenGL 3.3 core renderer (the only module allowed to call OpenGL).
/// That work belongs to Phase 4 (see docs/ROADMAP.md). Until then this function is the module's
/// only symbol: it keeps the `studyapp_render_gl` target compiling and linking with its final
